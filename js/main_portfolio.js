...
/* Unitec Project Folder light box*/
	$(function(){
	...
	$(".js-modal-close, .modal-overlay").click(function() {
	    $(".project_modal_box, .modal-overlay").fadeOut(500, function() {
	        $(".modal-overlay").remove();
	    });
	...
	$(window).resize(function() {
	    $(".project_modal_box").css({
	        top: ($(window).height() - $(".project_modal_box").outerHeight()) / 2,
	        left: ($(window).width() - $(".project_modal_box").outerWidth()) / 2
	    });
	});
